...
<head>
<meta charset="utf-8"/>
<title>CDC - Assessments - Start | Universitas Sriwijaya</title>
...
<body class="page-md page-quick-sidebar-over-content">
    ...
    <div class="page-content">
    	<div class="container">
    				...
    				<div class="center-body">
			    		<div class="row">
			    			<div class="col-sm-6 margin-bottom-30">
			    				<a class="webapp-btn" href="registrations.php">
			    					<h3>Registrations</h3>
			    					<p>New Members</p>
			    				</a>
			    			</div>
			    			<div class="col-sm-6 margin-bottom-30">
			    				<a class="webapp-btn" href="reports.php">
			    					<h3>Reports</h3>
			    					<p>View Reports</p>
			    				</a>
			    			</div>
			    		...
			    		<div class="row">
			    			<div class="col-sm-6 sm-margin-bottom-30">
			    				<a class="webapp-btn" href="members.php">
			    					<h3>Member Area</h3>
			    					<p>Login, Manage and Assessments</p>
			    				</a>
			    			</div>
			    			<div class="col-sm-6">
			    				<a class="webapp-btn" href="reset.php">
			    					<h3>Reset</h3>
			...
			<!-- Copyright BEGIN -->
			<p class="copyright">2015 © CDC Unsri, Designed by keenthemes.</p>
			<!-- Copyright END -->
    	</div>
    </div>
	<!-- PAGE CONTENT END -->
