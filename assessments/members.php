...
<head>
<meta charset="utf-8"/>
<title>CDC - Member Area | Universitas Sriwijaya</title>
	    			...
	    			<div class="col-md-12">
						...
						<div class="portlet light bordered">
							...
							<div class="portlet-body" id="content">
    							ini content untuk guidelines coming soon!!!
							</div>
						</div>
						<!-- END PORTLET-->
	    			</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		$("#guidelines").click(function() {
			$.ajax({
				url: "controllers/members_area_controller.php?action=Guidelines",
		...
		$("#login").click(function() {
			$.ajax({
				url: "controllers/members_area_controller.php?action=Login",
				success: function(data) {
					$("#title").text('Login');
					$("#content").html(data);
